...
class Component{
  constructor(arg0) {
    var {name: v0_0, memberNames: v0_1, memberTypes: v0_2 } = arg0;
    ...
    const ret = exports1['toxoid:api/ecs#[constructor]component'](ptr1, len1, result3, len3, ptr4, len4);
    var handle6 = ret;
    var rsc5 = new.target === Component ? this : Object.create(Component.prototype);
    ...
    Object.defineProperty(rsc5, symbolDispose, { writable: true, value: function () {
      ...
      rsc5[symbolRscHandle] = null;
      exports0['26'](handleTable7[(handle6 << 1) + 1] & ~T_FLAG);
    }});
    return rsc5;
  }
}
...
Component.prototype.getId = function getId() {
  ...
  const ret = exports1['toxoid:api/ecs#[method]component.get-id'](handle0);
  return BigInt.asUintN(64, ret);
};

const $init = (() => {
  let gen = (function* init () {
    const module0 = fetchCompile(new URL('./toxoid_api.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./toxoid_api.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ({ exports: exports0 } = yield instantiateCore(yield module2));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      '[export]toxoid:api/ecs': {
        '[resource-drop]component': trampoline1,
        '[resource-new]component': trampoline0,
      },
      wasi_snapshot_preview1: {
        clock_time_get: exports0['19'],
        environ_get: exports0['17'],
        environ_sizes_get: exports0['18'],
        fd_close: exports0['20'],
        fd_fdstat_get: exports0['21'],
    ...
    ({ exports: exports2 } = yield instantiateCore(yield module1, {
      ...
      'wasi:filesystem/types@0.2.0': {
        ...
        '[method]descriptor.get-flags': exports0['4'],
...
export { ecs, ecs as 'toxoid:api/ecs',  }